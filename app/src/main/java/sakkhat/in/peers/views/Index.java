...
public class Index
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadTemplate(R.layout.activity_base);
    ...
    public void initListeners(){
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                p2pManager.discoverPeers(p2pChannel, Index.this);
        ...
        deviceListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                p2pManager.connect(p2pChannel,config, Index.this);
                Toast.makeText(Index.this, "Connection establishing...", Toast.LENGTH_SHORT).show();
            }
        });
    }
